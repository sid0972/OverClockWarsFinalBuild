<?php
  ...
  $old_passwd = mysql_real_escape_string($_POST['old_passwd']);
  $new_passwd = mysql_real_escape_string($_POST['new_passwd']);
  $new_passwd2 = mysql_real_escape_string($_POST['new_passwd2']);
