...
<table align="center" class="table">
	<tr>
		<td class="table_header" colspan="2" align="center"><br><br><br><?=$websitename;?></b><br><br> </td>
	</tr>
	...
	<tr>
		<td colspan="2" class="upload_info" align="center">
			<b>Allowed Types:</b> <?=implode($allow_types, ", ");?><br /><br />
			<b>Max size per file:</b> <?=$max_file_size/1024?>MB.<br /><br />
			<b>Max size for all files combined:</b> <?=$max_combined_size/1024?>MB.<br /><br />
		</td>
	</tr>
	<?For($i=0;$i <= $file_uploads-1;$i++) {?>
		<tr>
			<td class="table_body" width="20%" align="right"><b>Select File:</b> </td>
			<td class="table_body" width="80%" align="right"><input type="file" name="file[]" size="30" /></td>
		</tr>
	<?}?>
	<tr>
		<td colspan="2" align="center" class="table_footer"><br>
...
<table class="table" style="border:0px;" align="center">
	<tr>
		<td><br><div class="copyright">Courtesy of&nbsp;&copy;<a href="http://www.phphq.net/?script=phUploader" target="_blank" title="Uploader Powered By phUploader &lt;www.phphq.net&gt;">phUploader</a></div></td>
	</tr>
	<tr>
		<td align="center"><br><br><br><br><br><a href="member.php">Go Back</a></td>
	</tr>
</table>
</body>
</html>
