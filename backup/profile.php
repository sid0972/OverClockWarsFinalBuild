...
<form action="post_insert.php?id=<?php echo $name ?>" method="post">
	...
	<textarea size="40" rows="6" cols="80" name="text_post" maxlength="250"></textarea><br><br>
...
?> 
            <tr>
            <td class="text" align="center"><? echo htmlspecialchars($row['post_by']); ?></td>
            <td class="text" align="center"><? echo htmlspecialchars($row['post_content']); ?></td>
...
for ($i=1; $i<=$total_pages; $i++) { 
            echo "<a href='profile.php?page=".$i."&id=".$name."'>".$i."</a> "; 
}
}
do_html_footer();
?>
